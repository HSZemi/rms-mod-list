<footer class="footer">
    <div class="container content has-text-grey-light is-size-7">
        <p>Made by <a href="https://aoe2.se" rel="author" class="has-text-grey">Siege Engineers</a>. You can contribute
            to this project on <a href="https://github.com/SiegeEngineers/rms-mod-list" rel="nofollow" class="has-text-grey">GitHub</a>.
        </p>
        <p>Age of Empires II &copy; Microsoft Corporation.<br/>
            <b>Map Mods</b> was created under Microsoft's "<a href="https://www.xbox.com/en-us/developers/rules"
